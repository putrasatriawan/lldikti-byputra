        ...
        <div class="navtop" style="height: 100%;">
            <div class="container d-flex justify-content-between" style="height:100%">
                ...
                <ul class="navbar-nav d-flex flex-row align-items-center" id="navtopr">
                    <li>
                        <a class="text-white mr-3" href="#"><i class="fa-brands fa-twitter"></i></a>
                    </li>
                    <li>
                        <a class="text-white mr-3" href="#"><i class="fa-brands fa-instagram"></i></a>
                    </li>
                    <li>
                        <a class="text-white mr-3" href="#"><i class="fa-brands fa-facebook-f"></i></a>
                    </li>
                    <li>
    ...
    <nav class="navbar navbar-light navbar-expand-lg bg-white" style="height: 11vh;">
        <div class="container py-2">
            ...
            <button class="navbar-toggler float-right mr-3" type="button" data-toggle="collapse" data-target="#navcol-1"
                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navcol-1" <span
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="navbar-nav align-items-center ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url('Berita'); ?>">Berita</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="<?php echo base_url('Layanan/layanan_kami'); ?>">
                                        Layanan
                                        Kami
                                    </a></li>
                                <li><a class="dropdown-item" href="<?php echo base_url('Layanan/cara_pengajuan'); ?>">
                                        Cara
                                        Pengajuan Layanan </a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="<?php echo base_url('Informasi_publik'); ?>"> Informasi Publik
                            </a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo base_url('Informasi_publik'); ?>">
                                        Standart
                                ...
                                <li><a class="dropdown-item" href="#"> Produk Hukum &raquo; </a>
                                    <ul class="submenu dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item"
                                                ...
                                                Pemerintah</a></li>
                                        <li><a class="dropdown-item"
                                                href="<?php echo base_url('Informasi_publik/sk_dirjen'); ?>">SK
                                                DIRJEN</a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a class="dropdown-item" href="<?php echo base_url('Informasi_publik/ppid'); ?>">
                                        PPID
                                    </a></li>
                                <li><a class="dropdown-item"
                                ...
                                <li><a class="dropdown-item"
                                        href="<?php echo base_url('Informasi_publik/peta_bisnis_lldikti'); ?>"> Peta
                                        Proses
                                ...
                                <li><a class="dropdown-item"
                                        ...
                                        Pedoman </a></li>
                                <li><a class="dropdown-item"
                                        href="<?php echo base_url('Informasi_publik/materi_kegiatan'); ?>"> Materi
                                        Kegiatan
                                    </a></li>
                                <li><a class="dropdown-item"
                                        href="<?php echo base_url('Informasi_publik/buletin_lldikti'); ?>"> Buletin
                                        LLDIKTI
                                        Wilayah IV </a></li>
                                <li><a class="dropdown-item"
                                ...
                                <li><a class="dropdown-item"
                                        href="<?php echo base_url('Informasi_publik/buku_statistik'); ?>"> Buku
                                        Statistik
                                        Perguruan Tinggi </a></li>
                                <li><a class="dropdown-item"
                                        href="<?php echo base_url('Informasi_publik/agenda_kegiatan'); ?>"> Agenda
                                        Kegiatan
                                    </a></li>
...
<div class="rounded-pill fixed-bottom bg-primary text-center m-4 px-3 py-2 text-light" style="width:fit-content;">
    <p class="m-0">Kontak dan Pengaduan</p>
</div>