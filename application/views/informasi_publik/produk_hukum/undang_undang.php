<section class="clean-block clean-hero" style="background-image:url(&quot;../assets/img/dash1.jpg&quot;);color:rgba(9, 162, 255, 0.85);">
    <div class="text">
        ...
        <h1 style="color: black;">Undang - Undang</h1>
    </div>
</section>
<section>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p>
                    <a href="">UUD TAHUN 1945 (Naskah Asli)</a>
                    <br>
                    <a href="">UUD 1945 (Perubahan I)</a>
                    <br>
                    <a href="">UUD 1945 (Perubahan II)</a>
                    <br>
                    <a href="">UUD 1945 (Perubahan III)</a>
                    <br>
                    <a href="">UUD 1945 (Perubahan IV)</a>
                    <br>
                    <a href="">UUD 1945 Perubahan (Keseluruhan)</a>
                </p>
                <h5><b>Undang-Undang</b></h5>
                <ul>
                    <?php for ($x = 1; $x <= 14; $x++) { ?>
                        <li><a href="">Undang-undang Republik Indonesia Nomor 11 Tahun 2014 Tentang Keinsinyuran</a></li>
                    <?php }; ?>
                </ul>
                <table class="table ">
                    <thead>
