                                ...
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="https://static.turbosquid.com/Preview/001292/481/WV/_D.jpg"
                                            class="rounded-circle user_img_ku">
                                    </div>
                    ...
                    <div class="card-body msg_card_body" id="letakpesan">
                        <div class="d-flex justify-content-start mb-4">
                            <div class="text-center">
                                <img src="https://sintesa.net/wp-content/uploads/2019/05/livechat.png"
                                    class="rounded-circle user_img_msg">
                                <br>
                                <p class="text-center" id="textnya">Hay, <?= $nama ?>, <br>Ayo Chat temanmu Sekarang !,
                                </p>
                            </div>
                        </div>
