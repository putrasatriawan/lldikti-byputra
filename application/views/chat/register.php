        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 order-md-2">
                    <img src="<?= base_url() ?>/assets/login/images/undraw_file_sync_ot38.svg" alt="Image"
                        class="img-fluid">
                </div>
                <div class="col-md-6 contents">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <input type="submit" value="Sign Up" id="btnLogin"
                                class="btn text-white btn-block btn-primary">
                            <p class="text">Sudah punya Akun? , <a href="<?= base_url() ?>chat/login"
                                    class="link-primary text-center">Signup</a></p>
