...
<head>
    ...
    <title>Login Chat - LLDIKTI</title>
</head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 order-md-2">
                    <img src="<?= base_url() ?>/assets/img/lldikti.jpg" alt="Image" class="img-fluid">
                </div>
                <div class="col-md-6 contents">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="mb-4">
                                <h3>Sign In to <strong>Chat</strong></h3>
                                <p class="mb-4">LLDIKTI-4 Admin</p>
                            </div>
                            ...
                            <p class="text">Belum punya Akun? , <a href="<?= base_url() ?>register"
                                    class="link-primary text-center">register</a></p>
                        </div>
                    </div>
